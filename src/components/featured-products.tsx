...
export function FeaturedProducts() {
  const { products, isLoading: storeIsLoading, actions } = useProductStore((state) => ({
    ...
    return (
        <section className="w-full py-12 md:py-24 lg:py-32">
            <div className="container mx-auto px-4 md:px-6">
                <h2 className="text-3xl font-bold tracking-tighter text-center sm:text-4xl md:text-5xl mb-12">Productos Destacados</h2>
        ...
        >
          <CarouselContent>
            {featuredProducts.map((product, index) => (
              <CarouselItem key={`${product.id}-${index}`} className="md:basis-1/2 lg:basis-1/3 xl:basis-1/4">
